...
//    endOther("abc", "abXabc") → true
    ...
    public boolean endOther(String a, String b) {
        a = a.toLowerCase();
        b = b.toLowerCase();
        boolean bInA = a.length() >= b.length()
                && a.substring(a.length() - b.length()).equals(b);
        boolean aInB = b.length() >= a.length()
...
//    withoutEnd("coding") → "odin"
    public String withoutEnd(String str) {
        ...
        if (str.length() >= 2) {
            return s;
        } else return "String is too short!";
    }
...
//    middleTwo("Practice") → "ct"
    public String middleTwo(String str) {
        String rMid = str.substring(str.length() / 2);
        String lMid = str.substring((str.length() - 1) / 2);
        return lMid.substring(0, 1) + rMid.substring(0, 1);
    }
...
//    lastChars("hi", "") → "h@"
    public String lastChars(String a, String b) {
        if (a.equals("") && b.equals("")) {
            ...
            return a.charAt(0) + "@";
        } else return a.charAt(0) + b.substring(b.length() - 1);
    }
...
//    lastTwo("ab") → "ba"
    ...
    public String lastTwo(String str) {
        if (str.length() >= 2) {
            ...
            return base + str.substring(str.length() - 1) + end.substring(0, 1);
...
//    withoutX2("Hi") → "Hi"
    ...
    public String withoutX2(String str) {
        if (str.length() == 1 && str.equals("x") || str.length() == 0) {
            return "";
        }
